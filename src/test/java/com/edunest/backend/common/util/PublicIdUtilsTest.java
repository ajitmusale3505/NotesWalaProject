...
class PublicIdUtilsTest {
    ...
    @Test
    void generatesExpectedPublicIds() {
    ...
    @Test
    void acceptsLegacyNumericIdsForBackwardCompatibility() {
    ...
    @Test
    void rejectsWrongPublicIdPrefix() {
        assertThrows(
                BadRequestException.class,
                () -> PublicIdUtils.parseUniversityId("C10001"));
    }
}

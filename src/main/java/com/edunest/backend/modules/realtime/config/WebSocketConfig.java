package com.edunest.backend.modules.realtime.config;
import com.edunest.backend.modules.realtime.security.JwtStompInterceptor;
...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
 ...
 @Override public void registerStompEndpoints(StompEndpointRegistry registry){registry.addEndpoint("/ws").setAllowedOriginPatterns("*").addInterceptors(jwtStompInterceptor);}
}